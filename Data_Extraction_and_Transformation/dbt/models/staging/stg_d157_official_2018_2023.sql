-- Staging model for D157 Official 2018-2023 data
-- This model cleans and standardizes the raw CDC WONDER data

{{ config(materialized='view') }}

with source_data as (
    select * from {{ source('cdc_wonder_raw', 'd157_official_2018_2023') }}
),
...
cleaned_data as (
    select
        ...
        'D157' as dataset_code,
        'Official 2018-2023' as dataset_description
