-- Staging model for D176 Provisional 2023-Current data
-- This model cleans and standardizes the raw CDC WONDER data

{{ config(materialized='view') }}

with source_data as (
    select * from {{ source('cdc_wonder_raw', 'd176_provisional_2023_current') }}
),
...
cleaned_data as (
    select
        ...
        'D176' as dataset_code,
        'Provisional 2023-Current' as dataset_description
